...
const benefits = [
  { label: 'Двойные баллы в выходные дни', keys: ['standard', 'premium', 'vip'] },
  { label: 'Бонус на день рождения', keys: ['standard', 'premium', 'vip'] },
  { label: 'Скидки на непопулярные маршруты', keys: ['premium', 'vip'] },
  { label: 'Акции на дополнительные услуги', keys: ['premium', 'vip'] },
  { label: 'Ранний доступ к покупке в праздничные дни', keys: ['vip'] },
];

const footnotes = [
  'Двойные баллы в выходные – ×2 балла за поездки в субботу и воскресенье',
  ...
  'Акции на дополнительные услуги – скидки до 15% на питание, а также комплект постельного белья (дальние расстояния)',
];
